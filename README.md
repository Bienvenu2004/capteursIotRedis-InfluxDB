# 📊 Analyse et stockage des données temporelles pour capteurs IoT

> *Solution complète avec Redis Time-Series et InfluxDB pour la gestion de données IoT*
...
- **Redis avec module Time-Series** pour le stockage haute performance des données de capteurs
...
- [Documentation Redis Time-Series](https://redis.io/docs/stack/timeseries/)
- [Documentation InfluxDB](https://docs.influxdata.com/)
- [Guide Redis Sentinel](https://redis.io/topics/sentinel)
